...
<title>Sell Dead Mobile Phone Online | YourMobileBuyer</title>
<meta name="description" content="Sell your dead mobile phone online at best price. Even if it doesn’t switch on, we buy it! Free pickup & instant payment. Secure and hassle-free.">
...
<div class="hero-box">
<h5 class="fw-semibold mb-3 text-center">Select Your Dead Mobile</h5>
...
<button class="btn btn-outline-danger condition-btn" data-value="yes">Phone Dead: Yes</button>
<button class="btn btn-outline-success condition-btn" data-value="no">Phone Dead: No</button>
</div>
